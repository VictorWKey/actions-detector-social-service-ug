...
# Directorios
input_root = "Equipo1_rawData" 
output_root = "Equipo1_cleanData"

# Crear la carpeta de salida si no existe
os.makedirs(output_root, exist_ok=True)

# Recorrer todas las subcarpetas dentro de cleanData
for subfolder in os.listdir(input_root):
    ...
    if os.path.isdir(input_subfolder):
        ...
        # Procesar los primeros 20 archivos CSV dentro de la subcarpeta
        csv_files = [f for f in os.listdir(input_subfolder) if f.endswith(".csv")][:20]
