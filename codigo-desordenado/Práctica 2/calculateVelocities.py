...
# Directorios
input_root = 'distanciasPractice2'  # Carpeta madre con los archivos de distancias
output_root = 'velocidadesPractice2'  # Carpeta madre para los archivos de velocidades
